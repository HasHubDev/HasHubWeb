...
export function Sidebar({ isOpen, onClose, currentPage, currentSection, onSectionChange }: SidebarProps) {
...
export function Sidebar({ isOpen, onClose, currentPage }: SidebarProps) {
  const [expandedItems, setExpandedItems] = useState<Record<string, boolean>>({
    playground: true, // Playground açık başlasın
    manage: false,
    optimize: false
  });
        ...
        <div className="p-4">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">
              AI-powered document processing and vector search
            </p>
          </div>
