        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-end space-x-3">
            <div className="flex-1">
              <div className="relative">
                <textarea
                  ...
                  className="w-full bg-secondary/60 border border-border/30 rounded-2xl px-4 py-3 pr-12 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-colors"
                  rows={1}
            ...
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground w-12 h-12 rounded-2xl flex-shrink-0"
            >
